          ...
          <Bot>
            <Info>
              ...
              <Resumen>
                ...
                <ResumenItem>
                  <ResumenItemTexto>Subtotal</ResumenItemTexto>
                  <ResumenItemPrecio>$ 130</ResumenItemPrecio>
                </ResumenItem>
                <ResumenItem>
                  <ResumenItemTexto>Costo de Envio</ResumenItemTexto>
                  <ResumenItemPrecio>$ 5</ResumenItemPrecio>
                </ResumenItem>
                <ResumenItem>
                  <ResumenItemTexto>Promoción - Envio Gratis:</ResumenItemTexto>
                  <ResumenItemPrecio>$ -5</ResumenItemPrecio>
                </ResumenItem>
                <ResumenItem tipo="total">
                  <ResumenItemTexto>Total</ResumenItemTexto>
                  <ResumenItemPrecio>$130</ResumenItemPrecio>
                </ResumenItem>
